...
export type InputElementProps = typeof __propDef.props;
export type InputElementEvents = typeof __propDef.events;
export type InputElementSlots = typeof __propDef.slots;
export default class InputElement extends SvelteComponent<InputElementProps, InputElementEvents, InputElementSlots> {
}
export {};
