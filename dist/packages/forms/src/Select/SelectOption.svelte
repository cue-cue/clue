...
<style>.ClueSelectOption {
  margin: 0;
  padding: 12px;
  color: var(--clue-color-gray-600);
  display: flex;
  align-items: center;
  cursor: pointer;
  border-radius: 10px;
...
.ClueSelectOption:hover {
  background: var(--clue-color-primary-10);
}
.ClueSelectOption:active {
  background: var(--clue-color-primary-50);
}</style>