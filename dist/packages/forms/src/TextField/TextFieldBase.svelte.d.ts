...
import { type ActionListParams } from '../../../utils/src/actions/actionList.js';
...
export type TextFieldBaseProps = typeof __propDef.props;
export type TextFieldBaseEvents = typeof __propDef.events;
export type TextFieldBaseSlots = typeof __propDef.slots;
export default class TextFieldBase extends SvelteComponent<TextFieldBaseProps, TextFieldBaseEvents, TextFieldBaseSlots> {
    get inputController(): {
        clear: (() => void) | undefined;
        update: ((callback: (currentValue: any) => any) => void) | undefined;
        set: ((newValue: any) => void) | undefined;
